...
// ─── IMAGES ──────────────────────────────────────────────────────────
const I = [
  "https://i.ibb.co/Zpv9j47X/mixboard-image-26.png",
  "https://i.ibb.co/KxZx2D5V/mixboard-image-27.png",
  "https://i.ibb.co/LdpQ99Tj/mixboard-image-28.png",
  "https://i.ibb.co/jZbg72wS/mixboard-image-29.png",
  "https://i.ibb.co/fVtzhdbD/mixboard-image-31.png",
  "https://i.ibb.co/HTnGqnsP/mixboard-image-32.png",
  "https://i.ibb.co/S4bJvycf/mixboard-image-34.png",
  "https://i.ibb.co/R8QFnVB/mixboard-image-35.png",
  "https://i.ibb.co/d0Km2Y2v/mixboard-image-36.png",
  "https://i.ibb.co/20XxtbCH/mixboard-image-39.png",
  "https://i.ibb.co/TS1SRBZ/mixboard-image-40.png",
  "https://i.ibb.co/CKvjN3hY/mixboard-image-41.png",
  "https://i.ibb.co/FqYPRvbx/mixboard-image-42.png",
  "https://i.ibb.co/CKS23Hhq/mixboard-image-43.png",
  "https://i.ibb.co/32DWrh8/mixboard-image-44.png",
  "https://i.ibb.co/jPLWgdJM/mixboard-image-45.png",
  "https://i.ibb.co/DgSXmv68/mixboard-image-46.png",
  "https://i.ibb.co/rGqCCbBG/mixboard-image-47.png",
  "https://i.ibb.co/mr6hkgFy/mixboard-image-48.png",
  "https://i.ibb.co/C5Y1ks0k/mixboard-image-49.png",
  "https://i.ibb.co/gMSk1PBm/mixboard-image-50.png",
  "https://i.ibb.co/JjjMLZw0/mixboard-image-51.png",
  "https://i.ibb.co/1G1RcmBb/mixboard-image-52.png",
  "https://i.ibb.co/0jMHC6b6/mixboard-image-53.png",
  "https://i.ibb.co/fGpPyF1t/mixboard-image-54.png",
  "https://i.ibb.co/GQW8GWWw/mixboard-image-55.png",
  "https://i.ibb.co/WWh5Y27H/mixboard-image-56.png",
  "https://i.ibb.co/Hp4Zh20r/mixboard-image-57.png",
  "https://i.ibb.co/pjS5PcCD/mixboard-image-58.png",
  "https://i.ibb.co/q35fM5nJ/mixboard-image-59.png",
  "https://i.ibb.co/Y4NV7grw/mixboard-image-60.png",
  "https://i.ibb.co/RkYC0PV4/mixboard-image-61.png",
  "https://i.ibb.co/LhbsQSDB/mixboard-image-62.png",
  "https://i.ibb.co/4ZDGTXgS/mixboard-image-63.png",
  "https://i.ibb.co/fdnvcGqq/mixboard-image-64.png",
  "https://i.ibb.co/7B4HHky/mixboard-image-65.png",
  "https://i.ibb.co/p6JSqmXr/mixboard-image-66.png",
  "https://i.ibb.co/J9kxNLn/mixboard-image-67.png",
  "https://i.ibb.co/6RTCnfPH/mixboard-image-68.png",
  "https://i.ibb.co/wFmcVXmf/mixboard-image-69.png",
  "https://i.ibb.co/GQKt9G9m/mixboard-image-71.png",
  "https://i.ibb.co/ym2LDbWc/mixboard-image-72.png",
  "https://i.ibb.co/fGBddskr/mixboard-image-73.png",
  "https://i.ibb.co/23vry85M/mixboard-image-74.png",
  "https://i.ibb.co/TDfh2Vc2/mixboard-image-75.png",
  "https://i.ibb.co/hFsQZPTb/mixboard-image-76.png",
  "https://i.ibb.co/SXKfdWsx/mixboard-image-77.png",
  "https://i.ibb.co/0pHGfmdS/mixboard-image-78.png",
  "https://i.ibb.co/WWGL1QcG/mixboard-image-79.png",
];

// ─── IMAGE POOLS (per food category) ─────────────────────────────────
// Each section gets its own slice so no cross-category image bleed
const P = {
  beef:       I.slice(0, 18),   // 18 images → 18 beef items  (1:1 match!)
  naimi:      I.slice(18, 24),  // 6  images → 6  naimi items (1:1 match!)
  aus:        I.slice(24, 30),  // 6  images → 6  aus items   (1:1 match!)
  chicken:    I.slice(30, 41),  // 11 images → 11 poultry     (1:1 match!)
  grillReady: I.slice(41, 49),  // 8  images → 16 items  (cycles within grill photos)
  fryReady:   I.slice(30, 49),  // 19 images → 13 items  (unique per item)
  soups:      I.slice(8,  18),  // 10 images → 3  soups
  salads:     I.slice(18, 28),  // 10 images → 5  salads
  hot:        I.slice(28, 38),  // 10 images → 4  hot apps
  mahashi:    I.slice(33, 43),  // 10 images → 5  mahashi
  nile:       I.slice(0,  49),  // all 49    → 15 nile dishes (cycles, spread out)
  grills:     I.slice(40, 49),  // 9  images → 13 grills (cycles within grill range)
  tageen:     I.slice(20, 44),  // 24 images → 18 tagens (unique per item)
  feteer:     I.slice(5,  20),  // 15 images → 5  feteer
  sides:      I.slice(35, 49),  // 14 images → 3  sides
};
...
const rawRestaurant = [
  ...
  { section: "tageen",  title: "طواجن وخضار",        titleEn: "Tagens",          pool: "tageen",  items: [
    ...
    { ar: "طاجن مسقعة بالبشاميل",      en: "Moussaka Béchamel",     price: "45 درهم" },
    ...
    { ar: "أرز معمر بالحمام",          en: "Maamar Rice Pigeon",    price: "70 درهم" },
    { ar: "ورق عنب بالكوارع",          en: "Grape Leaves Trotters", price: "50 درهم" },
    { ar: "طاجن موزة بالبطاطس",        en: "Lamb Shank Tagen",      price: "65 درهم" },
  ]},
...
function buildData(raw, type) {
  ...
  raw.forEach(sec => {
    ...
    const pool = P[sec.pool] || I; // use category-specific pool
    ...
    sec.items.forEach((item, idx) => {
      items.push({
        ...
        img: pi(pool, idx),           // cycles within its own category pool
...
const IconMenu   = ({ size }) => <svg width={size||22} height={size||22} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3zm0 0v7"/></svg>;
const IconInfo   = ({ size }) => <svg width={size||22} height={size||22} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>;
...
// ─── SCREEN COMPONENTS (outside App to avoid re-creation on render) ───

function HomeScreen({ allItems, cats, shopType, switchShopType, activeCat, setActiveCat,
  search, setSearch, reviews, go, addToCart, openDetail, handleSecretTap }) {
...
function MenuScreen({ items, cats, shopType, switchShopType, activeCat, setActiveCat,
  search, setSearch, addToCart, openDetail }) {
  return (
    <div>
      <div className="sth">
    ...
    <div>
      ...
      <div className="info-section" style={{ margin: "10px 15px 14px" }}>
        ...
        <div className="social-row">
          <a className="soc-btn" href={SOCIAL.facebook}  target="_blank" rel="noreferrer">
            <IconFacebook />فيسبوك
          </a>
          <a className="soc-btn" href={SOCIAL.instagram} target="_blank" rel="noreferrer">
            <IconInstagram />انستاجرام
          </a>
          <a className="soc-btn" href={SOCIAL.tiktok}    target="_blank" rel="noreferrer">
            <IconTikTok />تيك توك
          </a>
        </div>
      </div>
      ...
      <div className="platforms">
        <p className="plat-title">اطلب عبر تطبيقات التوصيل</p>
        <div className="plat-row">
          <a className="plat-btn talabat" href={SOCIAL.talabat}  target="_blank" rel="noreferrer">🛵 طلبات</a>
          <a className="plat-btn deliveroo" href={SOCIAL.deliveroo} target="_blank" rel="noreferrer">🚲 ديليفرو</a>
  ...
  return (
    <div className="shov" onClick={onClose} role="dialog" aria-modal="true">
      <div className="sh" onClick={e => e.stopPropagation()}>
        ...
        <input className="finp" value={phone} onChange={e => setPhone(e.target.value)} placeholder="+971..." type="tel" autoComplete="tel" inputMode="tel" />
...
export default function App() {
  ...
  const [adminItems,     setAdminItems]     = useState(INIT_ADMIN);
  ...
  const items = useMemo(() =>
    ALL_ITEMS.filter(it => {
      ...
      if (search) { const q = search.toLowerCase(); return it.name.includes(search) || it.nameEn.toLowerCase().includes(q); }
      return true;
    }),
  ...
  const saveItemEdit = useCallback((id, updates) => {
    setAdminItems(prev => ({ ...prev, [id]: { ...prev[id], ...updates, price: parsePrice(updates.priceStr || prev[id].priceStr) } }));
    setEditingItem(null);
    showToast("✓ تم الحفظ");
  }, [showToast]);
  ...
  const actionPros = { addToCart, openDetail, go };

  return (
    <div className="shell" dir="rtl">
      <div className="scr" ref={scrollRef} key={page}>
        {page === "home"    && <HomeScreen allItems={ALL_ITEMS} cats={cats} reviews={reviews} handleSecretTap={handleSecretTap} {...shopProps} {...actionPros} />}
        {page === "menu"    && <MenuScreen items={items} cats={cats} {...shopProps} {...actionPros} />}
        ...
        {page === "admin"   && (isAdmin
          ...
          : <HomeScreen allItems={ALL_ITEMS} cats={cats} reviews={reviews} handleSecretTap={handleSecretTap} {...shopProps} {...actionPros} />
        )}
        ...
        {[
          ...
          return (
            <button key={navItem.id} className={`nb ${activeNav===navItem.id?"on":""}`} onClick={() => go(navItem.id)}
              ...
              <NavIcon size={20} />
              {navItem.badge > 0 && <span className="nbdg">{navItem.badge > 99 ? "99+" : navItem.badge}</span>}
